...
@Decorator(
    selector: '[child-controller]', children: Directive.TRANSCLUDE_CHILDREN)
class ChildController {
  ChildController(
      BoundViewFactory boundViewFactory, ViewPort viewPort, Scope scope) {
...
main() {
  ...
  they('should create and destroy a child scope', [
    ...
    '<div>' +
        ...
        '    <span child-controller id="inside" probe="probe">inside {{ctx}};</span>'
            .trim() +
        '  </div>'.trim() +
  ...
  they('should play nice with other elements beside it', [
    ...
    expect(element).toHaveText(
        'repeat;repeat;repeat;repeat;if;repeat2;repeat2;repeat2;repeat2;');
    rootScope.apply(() {
