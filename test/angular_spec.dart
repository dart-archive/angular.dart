  ...
  describe('symbols', () {
    ...
    it('should not export unknown symbols from angular', () {
      ...
      var ALLOWED_NAMES = [
        ...
        "angular.tracing.createScope",
        "angular.tracing.detectWTF",
        "angular.tracing.endAsync",
        "angular.tracing.enter",
        "angular.tracing.enter1",
        "angular.tracing.leave",
        "angular.tracing.leaveVal",
        "angular.tracing.startAsync",
        "angular.tracing.wtfEnabled",
