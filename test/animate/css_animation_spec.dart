...
main() {
  describe('CssAnimation', () {
    ...
    it('should correctly respond to an animation lifecycle', async(() {
      _.compile(
          "<style>.event { transition: all 500ms; -webkit-transition: all 500ms; }</style>" +
    ...
    it('should swap removeAtEnd class if initial style is display none',
        async(() {
      _.compile(
          "<style>.event { transition: all 500ms; -webkit-transition: all 500ms; display: none; }</style>"
    ...
    it('should add classes at end', async(() {
      _.compile(
          "<style>.event { transition: all 500ms; -webkit-transition: all 500ms; }</style><div></div>");
      _.rootElements.forEach((e) => document.body.append(e));
      var element = _.rootElements[1];
    ...
    it('should clean up event classes when canceled after read', async(() {
      ...
      var element = _.rootElements[1];
      var animation =
          new CssAnimation(element, "event", "event-active", addAtEnd: 'magic');
