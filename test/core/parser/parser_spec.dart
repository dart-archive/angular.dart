  ...
  describe('parse', () {
    ...
    describe('named arguments', () {
      ...
      it('should be supported for member calls (map)', () {
        ...
        expect(eval("this.sub1(1)")).toEqual(1);
        expect(eval("this.sub1(3, b: 2)")).toEqual(1);

        expect(eval("this.sub2()")).toEqual(0);
        expect(eval("this.sub2(a: 3)")).toEqual(3);
        expect(eval("this.sub2(a: 3, b: 2)")).toEqual(1);
        expect(eval("this.sub2(b: 4)")).toEqual(-4);
      });
