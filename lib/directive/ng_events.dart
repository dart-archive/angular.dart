...
@Decorator(
    selector: '[ng-beforecopy]', map: const {'ng-beforecopy': '&onBeforeCopy'})
@Decorator(
    selector: '[ng-beforecut]', map: const {'ng-beforecut': '&onBeforeCut'})
@Decorator(
    selector: '[ng-beforepaste]',
    map: const {'ng-beforepaste': '&onBeforePaste'})
...
@Decorator(
    selector: '[ng-dragenter]', map: const {'ng-dragenter': '&onDragEnter'})
@Decorator(
    selector: '[ng-dragleave]', map: const {'ng-dragleave': '&onDragLeave'})
@Decorator(selector: '[ng-dragover]', map: const {'ng-dragover': '&onDragOver'})
@Decorator(
    selector: '[ng-dragstart]', map: const {'ng-dragstart': '&onDragStart'})
...
@Decorator(
    selector: '[ng-fullscreenchange]',
    map: const {'ng-fullscreenchange': '&onFullscreenChange'})
@Decorator(
    selector: '[ng-fullscreenerror]',
    map: const {'ng-fullscreenerror': '&onFullscreenError'})
...
@Decorator(
    selector: '[ng-mousedown]', map: const {'ng-mousedown': '&onMouseDown'})
@Decorator(
    selector: '[ng-mouseenter]', map: const {'ng-mouseenter': '&onMouseEnter'})
@Decorator(
    selector: '[ng-mouseleave]', map: const {'ng-mouseleave': '&onMouseLeave'})
@Decorator(
    selector: '[ng-mousemove]', map: const {'ng-mousemove': '&onMouseMove'})
@Decorator(selector: '[ng-mouseout]', map: const {'ng-mouseout': '&onMouseOut'})
@Decorator(
    selector: '[ng-mouseover]', map: const {'ng-mouseover': '&onMouseOver'})
@Decorator(selector: '[ng-mouseup]', map: const {'ng-mouseup': '&onMouseUp'})
@Decorator(
    selector: '[ng-mousewheel]', map: const {'ng-mousewheel': '&onMouseWheel'})
...
@Decorator(
    selector: '[ng-selectstart]',
    map: const {'ng-selectstart': '&onSelectStart'})
...
@Decorator(
    selector: '[ng-toucheancel]',
    map: const {'ng-touchcancel': '&onTouchCancel'})
@Decorator(selector: '[ng-touchend]', map: const {'ng-touchend': '&onTouchEnd'})
@Decorator(
    selector: '[ng-touchenter]', map: const {'ng-touchenter': '&onTouchEnter'})
@Decorator(
    selector: '[ng-touchleave]', map: const {'ng-touchleave': '&onTouchLeave'})
@Decorator(
    selector: '[ng-touchmove]', map: const {'ng-touchmove': '&onTouchMove'})
@Decorator(
    selector: '[ng-touchstart]', map: const {'ng-touchstart': '&onTouchStart'})
@Decorator(
    selector: '[ng-transitionend]',
    map: const {'ng-transitionend': '&onTransitionEnd'})
class NgEvent {
  ...
  void set onFullscreenChange(value) =>
      _initListener(_element.onFullscreenChange, value);
  void set onFullscreenError(value) =>
      _initListener(_element.onFullscreenError, value);
...
//  void set onSpeechChange(value)      => initListener(element.onSpeechChange,     value);
  ...
  void set onTransitionEnd(value) =>
      _initListener(_element.onTransitionEnd, value);
}
