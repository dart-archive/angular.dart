...
class DirectiveInjector implements DirectiveBinder {
  ...
  static _toVisibilityId(Visibility v) => identical(v, Visibility.LOCAL)
      ? VISIBILITY_LOCAL
      : (identical(v, Visibility.CHILDREN)
          ? VISIBILITY_CHILDREN
  ...
  DirectiveInjector(DirectiveInjector parent, appInjector, this._node,
      this._nodeAttrs, this._eventHandler, this.scope, this._animate,
      [View view, this._shadowBoundary])
      : _parent = parent,
  ...
  void bind(key, {dynamic toValue: DEFAULT_VALUE,
      Function toFactory: DEFAULT_VALUE, Type toImplementation, toInstanceOf,
      inject: const [], Visibility visibility: Visibility.LOCAL}) {
    assert(key != null);
    if (key is! Key) key = new Key(key);
    if (inject is! List) inject = [inject];

    _tempBinding.bind(key, Module.DEFAULT_REFLECTOR,
        toValue: toValue,
        toFactory: toFactory,
        toImplementation: toImplementation,
        inject: inject,
        toInstanceOf: toInstanceOf);

    bindByKey(
        key, _tempBinding.factory, _tempBinding.parameterKeys, visibility);
  }

  void bindByKey(Key key, Function factory, List<Key> parameterKeys,
    ...
    if (_key0 == null || identical(_key0, key)) {
      _key0 = key;
      _pKeys0 = parameterKeys;
      _factory0 = factory;
    } else if (_key1 == null || identical(_key1, key)) {
      _key1 = key;
      _pKeys1 = parameterKeys;
      _factory1 = factory;
    } else if (_key2 == null || identical(_key2, key)) {
      _key2 = key;
      _pKeys2 = parameterKeys;
      _factory2 = factory;
    } else if (_key3 == null || identical(_key3, key)) {
      _key3 = key;
      _pKeys3 = parameterKeys;
      _factory3 = factory;
    } else if (_key4 == null || identical(_key4, key)) {
      _key4 = key;
      _pKeys4 = parameterKeys;
      _factory4 = factory;
    } else if (_key5 == null || identical(_key5, key)) {
      _key5 = key;
      _pKeys5 = parameterKeys;
      _factory5 = factory;
    } else if (_key6 == null || identical(_key6, key)) {
      _key6 = key;
      _pKeys6 = parameterKeys;
      _factory6 = factory;
    } else if (_key7 == null || identical(_key7, key)) {
      _key7 = key;
      _pKeys7 = parameterKeys;
      _factory7 = factory;
    } else if (_key8 == null || identical(_key8, key)) {
      _key8 = key;
      _pKeys8 = parameterKeys;
      _factory8 = factory;
    } else if (_key9 == null || identical(_key9, key)) {
      _key9 = key;
      _pKeys9 = parameterKeys;
      _factory9 = factory;
    } else {
      throw 'Maximum number of directives per element reached.';
    }
  }
  ...
  Object _getByKey(Key key, Injector appInjector) {
    try {
      ...
      return isDirective
          ? _getDirectiveByKey(key, uid, appInjector)
          : _getById(uid);
  ...
  _getDirectiveByKey(Key k, int visibility, Injector appInjector) {
    ...
    while (ci != null && treeDepth >= 0) {
      do {
        if (ci._key0 == null) break;
        if (identical(ci._key0, k)) return ci._obj0 == null
            ? ci._obj0 = ci._new(k, ci._pKeys0, ci._factory0)
            : ci._obj0;
        if (ci._key1 == null) break;
        if (identical(ci._key1, k)) return ci._obj1 == null
            ? ci._obj1 = ci._new(k, ci._pKeys1, ci._factory1)
            : ci._obj1;
        if (ci._key2 == null) break;
        if (identical(ci._key2, k)) return ci._obj2 == null
            ? ci._obj2 = ci._new(k, ci._pKeys2, ci._factory2)
            : ci._obj2;
        if (ci._key3 == null) break;
        if (identical(ci._key3, k)) return ci._obj3 == null
            ? ci._obj3 = ci._new(k, ci._pKeys3, ci._factory3)
            : ci._obj3;
        if (ci._key4 == null) break;
        if (identical(ci._key4, k)) return ci._obj4 == null
            ? ci._obj4 = ci._new(k, ci._pKeys4, ci._factory4)
            : ci._obj4;
        if (ci._key5 == null) break;
        if (identical(ci._key5, k)) return ci._obj5 == null
            ? ci._obj5 = ci._new(k, ci._pKeys5, ci._factory5)
            : ci._obj5;
        if (ci._key6 == null) break;
        if (identical(ci._key6, k)) return ci._obj6 == null
            ? ci._obj6 = ci._new(k, ci._pKeys6, ci._factory6)
            : ci._obj6;
        if (ci._key7 == null) break;
        if (identical(ci._key7, k)) return ci._obj7 == null
            ? ci._obj7 = ci._new(k, ci._pKeys7, ci._factory7)
            : ci._obj7;
        if (ci._key8 == null) break;
        if (identical(ci._key8, k)) return ci._obj8 == null
            ? ci._obj8 = ci._new(k, ci._pKeys8, ci._factory8)
            : ci._obj8;
        if (ci._key9 == null) break;
        if (identical(ci._key9, k)) return ci._obj9 == null
            ? ci._obj9 = ci._new(k, ci._pKeys9, ci._factory9)
            : ci._obj9;
      } while (false);
  ...
  Object _getById(int keyId) {
    switch (keyId) {
      case INJECTOR_KEY_ID:
        return _appInjector;
      case DIRECTIVE_INJECTOR_KEY_ID:
        return this;
      case NODE_KEY_ID:
        return _node;
      case ELEMENT_KEY_ID:
        return _node;
      case NODE_ATTRS_KEY_ID:
        return _nodeAttrs;
      case ANIMATE_KEY_ID:
        return _animate;
      case SCOPE_KEY_ID:
        return scope;
      case ELEMENT_PROBE_KEY_ID:
        return elementProbe;
      case NG_ELEMENT_KEY_ID:
        return ngElement;
      case EVENT_HANDLER_KEY_ID:
        return _eventHandler;
      case SHADOW_BOUNDARY_KEY_ID:
        return _findShadowBoundary();
      case DESTINATION_LIGHT_DOM_KEY_ID:
        return _destLightDom;
      case SOURCE_LIGHT_DOM_KEY_ID:
        return _sourceLightDom;
      case VIEW_KEY_ID:
        return _view;
      default:
        throw new NoProviderError(_KEYS[keyId]);
    }
  }
    ...
    if (size > 15) {
      ...
      switch (size) {
        ...
        case 03:
          ...
          break;
        case 04:
          obj = fn(a01, a02, a03, a04);
          break;
        case 05:
          obj = fn(a01, a02, a03, a04, a05);
          break;
        case 06:
          obj = fn(a01, a02, a03, a04, a05, a06);
          break;
        case 07:
          obj = fn(a01, a02, a03, a04, a05, a06, a07);
          break;
        case 08:
          obj = fn(a01, a02, a03, a04, a05, a06, a07, a08);
          break;
        case 09:
          obj = fn(a01, a02, a03, a04, a05, a06, a07, a08, a09);
          break;
        case 10:
          obj = fn(a01, a02, a03, a04, a05, a06, a07, a08, a09, a10);
          break;
        case 11:
          obj = fn(a01, a02, a03, a04, a05, a06, a07, a08, a09, a10, a11);
          break;
        case 12:
          obj = fn(a01, a02, a03, a04, a05, a06, a07, a08, a09, a10, a11, a12);
          break;
        case 13:
          obj = fn(
  ...
  NgElement get ngElement {
    if (_ngElement == null) {
      _ngElement = new NgElement(_node, _appInjector.getByKey(ROOT_SCOPE_KEY),
          _animate, _destLightDom);
    }
    return _ngElement;
  }
  ...
  DestinationLightDom get _destLightDom =>
      _parent == null ? null : _parent.lightDom;

  ShadowBoundary _findShadowBoundary() => _shadowBoundary != null
      ? _shadowBoundary
      : getFromParentByKey(SHADOW_BOUNDARY_KEY);
}
...
class TemplateDirectiveInjector extends DirectiveInjector {
  ...
  TemplateDirectiveInjector(DirectiveInjector parent, Injector appInjector,
      Node node, NodeAttrs nodeAttrs, EventHandler eventHandler, Scope scope,
      Animate animate, this._viewFactory,
      [View view, ShadowBoundary shadowBoundary])
      : super(parent, appInjector, node, nodeAttrs, eventHandler, scope,
          animate, view, shadowBoundary);

  Object _getById(int keyId) {
    switch (keyId) {
      case VIEW_FACTORY_KEY_ID:
        return _viewFactory;
      case VIEW_PORT_KEY_ID:
        return ((_viewPort) == null)
            ? _viewPort = _createViewPort()
            : _viewPort;
      case BOUND_VIEW_FACTORY_KEY_ID:
        return (_boundViewFactory == null)
            ? _boundViewFactory = _viewFactory.bind(_parent)
            : _boundViewFactory;
      default:
        return super._getById(keyId);
    }
  }
...
class ComponentDirectiveInjector extends DirectiveInjector {
  ...
  ComponentDirectiveInjector(DirectiveInjector parent, Injector appInjector,
      EventHandler eventHandler, Scope scope, this._templateLoader,
      this._shadowRoot, LightDom lightDom, this._typeKey,
      [View view, ShadowBoundary shadowBoundary])
      : super(parent, appInjector, parent._node, parent._nodeAttrs,
          eventHandler, scope, parent._animate, view, shadowBoundary) {
  ...
  Object _getById(int keyId) {
    switch (keyId) {
      case TEMPLATE_LOADER_KEY_ID:
        return _templateLoader;
      case SHADOW_ROOT_KEY_ID:
        return _shadowRoot;
      case DIRECTIVE_INJECTOR_KEY_ID:
        return _parent;
      case COMPONENT_DIRECTIVE_INJECTOR_KEY_ID:
        return this;
