...
class EventHandler {
  ...
  EventHandler(this.rootElement, this.expando, this.exceptionHandler);
  void register(String eventName) {
    listeners.putIfAbsent(eventName, () {
      dom.EventListener eventListener = this.eventListener;
      var attachTo = rootElement.shadowRoot != null ? rootElement.shadowRoot : rootElement;
      attachTo.on[eventName].listen(eventListener);
