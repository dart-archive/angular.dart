...
class PlaybackHttpBackendConfig {
  ...
  requestKey(String url, {String method, bool withCredentials,
      String responseType, String mimeType, Map<String, String> requestHeaders,
      sendData, void onProgress(ProgressEvent e)}) {
    return JSON.encode({
      "url": url,
      "method": method,
...
class PlaybackHttpBackend implements HttpBackend {
  ...
  Future request(String url, {String method, bool withCredentials,
    ...
    return new Future.value(new mock.MockHttpRequest(
        playback['status'], playback['data'], playback['headers']));
  }
}
