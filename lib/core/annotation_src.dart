...
abstract class DirectiveModule {
  bind(key, {Function toFactory, inject, Visibility visibility: Visibility.DIRECT_CHILD});
}

typedef void DomModuleConfig(DirectiveModule module);
