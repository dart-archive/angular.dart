...
abstract class ParserBackend<T> {
  ...
  T newCallScope(String name, CallArguments arguments)
      => null;
  T newCallFunction(T function, CallArguments arguments)
      => null;
  T newCallMember(T object, String name, CallArguments arguments)
      => null;
