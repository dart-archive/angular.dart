...
main() {
  ...
  report('ident', () => lexer.call('ctrl foo baz ctrl.foo ctrl.bar ctrl.baz'));
  report('ident-path', () => lexer.call('a.b a.b.c a.b.c.d a.b.c.d.e.f'));
  report('num', () => lexer.call('1 23 34 456 12341234 12351235'));
  report('num-double', () => lexer.call('.0 .1 .12 0.123 0.1234'));
  report('string', () => lexer.call("'quick brown dog and fox say what'"));
