...
@MirrorsUsed(targets: const ['angular.benchmarks.watch_group'], override: '*')
...
void _groupAddRemove({bool observable}) {
  ...
  var testRun = () {
    for (int i = 0; i < 10; i++) {
      WatchGroup child = rootWatchGrp
          .newGroup(observable ? new _ObservableObj() : new _Obj())
...
class _ObservableObj extends ChangeNotifier {
  ...
  dynamic get a => __$a;
  dynamic __$a = 1;
  @reflectable set a(dynamic value) {
    __$a = notifyPropertyChange(#a, __$a, value);
  }
  ...
  dynamic get b => __$b;
  dynamic __$b = 2;
  @reflectable set b(dynamic value) {
    __$b = notifyPropertyChange(#b, __$b, value);
  }
  ...
  dynamic get c => __$c;
  dynamic __$c = 3;
  @reflectable set c(dynamic value) {
    __$c = notifyPropertyChange(#c, __$c, value);
  }
  ...
  dynamic get d => __$d;
  dynamic __$d = 4;
  @reflectable set d(dynamic value) {
    __$d = notifyPropertyChange(#d, __$d, value);
  }
  ...
  dynamic get e => __$e;
  dynamic __$e = 5;
  @reflectable set e(dynamic value) {
    __$e = notifyPropertyChange(#e, __$e, value);
  }
  ...
  dynamic get f => __$f;
  dynamic __$f = 6;
  @reflectable set f(dynamic value) {
    __$f = notifyPropertyChange(#f, __$f, value);
  }
  ...
  dynamic get g => __$g;
  dynamic __$g = 7;
  @reflectable set g(dynamic value) {
    __$g = notifyPropertyChange(#g, __$g, value);
  }
  ...
  dynamic get h => __$h;
  dynamic __$h = 8;
  @reflectable set h(dynamic value) {
    __$h = notifyPropertyChange(#h, __$h, value);
  }
  ...
  dynamic get i => __$i;
  dynamic __$i = 9;
  @reflectable set i(dynamic value) {
    __$i = notifyPropertyChange(#i, __$i, value);
  }
  ...
  dynamic get j => __$j;
  dynamic __$j = 10;
  @reflectable set j(dynamic value) {
    __$j = notifyPropertyChange(#j, __$j, value);
  }
  ...
  dynamic get k => __$k;
  dynamic __$k = 11;
  @reflectable set k(dynamic value) {
    __$k = notifyPropertyChange(#k, __$k, value);
  }
  ...
  dynamic get l => __$l;
  dynamic __$l = 12;
  @reflectable set l(dynamic value) {
    __$l = notifyPropertyChange(#l, __$l, value);
  }
  ...
  dynamic get m => __$m;
  dynamic __$m = 13;
  @reflectable set m(dynamic value) {
  ...
  dynamic get n => __$n;
  dynamic __$n = 14;
  @reflectable set n(dynamic value) {
    __$n = notifyPropertyChange(#n, __$n, value);
  }
  ...
  dynamic get o => __$o;
  dynamic __$o = 15;
  @reflectable set o(dynamic value) {
    __$o = notifyPropertyChange(#o, __$o, value);
  }
  ...
  dynamic get p => __$p;
  dynamic __$p = 16;
  @reflectable set p(dynamic value) {
    __$p = notifyPropertyChange(#p, __$p, value);
  }
  ...
  dynamic get q => __$q;
  dynamic __$q = 17;
  @reflectable set q(dynamic value) {
    __$q = notifyPropertyChange(#q, __$q, value);
  }
  ...
  dynamic get r => __$r;
  dynamic __$r = 18;
  @reflectable set r(dynamic value) {
    __$r = notifyPropertyChange(#r, __$r, value);
  }
  ...
  dynamic get s => __$s;
  dynamic __$s = 19;
  @reflectable set s(dynamic value) {
    __$s = notifyPropertyChange(#s, __$s, value);
  }
  ...
  dynamic get t => __$t;
  dynamic __$t = 20;
  @reflectable set t(dynamic value) {
    __$t = notifyPropertyChange(#t, __$t, value);
  }
}
